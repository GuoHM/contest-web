...
public class AdminInfo implements java.io.Serializable {
	...
	public AdminInfo(String adminId, String password, String name, String phone) {
	...
	public AdminInfo(String adminId, String password, String name, String phone, Set worksInfos, Set newses) {
		this.adminId = adminId;
		this.password = password;
		this.name = name;
		this.phone = phone;
