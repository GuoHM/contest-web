    ...
    <div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
        ...
        <div class="btn-group menubar-right">
            <button type="button" class="btn btn-default"><a
                    data-toggle="modal" data-target="#register" href=""><span
                    class="glyphicon glyphicon-th-large">注册</span></a></button>
            <button type="button" class="btn btn-default"><a
                    data-toggle="modal" data-target="#login" href=""><span
                    class="glyphicon glyphicon-user">登录</span></a></button>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row clearfix">
            <div class="col-xs-2 column" id="myScrollspy">
                <nav class="bs-docs-sidebar hidden-print hidden-xs hidden-sm affix">
                    <ul class="nav nav-tabs nav-stacked" data-spy="affix" data-offset-top="125">
                        <li><a href="#section-1" class="editor">比赛通知</a></li>
                        <li><a href="#section-2" class="elements">实施细则</a></li>
                        <li><a href="#section-3" class="widgets">重要信息及下载</a></li>
                    </ul>
                </nav>
            </div>
            ...
            <div class="col-xs-8 column">
                ...
                <div class="content"><p>各高校教务处、计算机教育负责人：</p>
                    <p>
                    ...
                    <p>大赛网站： <strong>http://202.120.165.61/contest</strong></p>
                    <p>大赛邮箱：<strong>jsjdasai@shiep.edu.cn</strong>、<strong>shjsj@tongji.edu.cn</strong>
                    </p>
                    <p>大赛办公室设在上海电力学院杨浦校区，地址：</p>
                    <address>上海市平凉路2103号上海电力学院教务处老行政楼305室<br/>邮编：200090<br/>联系电话：35303885</address>
                    <p>希望各高校积极宣传、认真组织学生参赛，通过竞赛培养学生的创新能力和团队协作精神，提高学生解决实际问题的能力。</p>
                </div>
                <div class="foot">
                    <p>上海市大学生计算机应用能力大赛组委会<br>
                        上海市教育委员会高教处</p>
                    <p>2016年10月</p>
                </div>
                ...
                <div class="content">
                    ...
                    <p>委&nbsp;&nbsp;&nbsp;员：王占全 &nbsp;车立娟&nbsp; 陈海建 &nbsp;陈章进 &nbsp;陈志云&nbsp; 杜　明 &nbsp;冯佳昕&nbsp; 顾顺德 &nbsp;顾振宇<br>
                        　　　　　　韩冬梅 &nbsp;黄冬梅 &nbsp;黄林鹏 &nbsp;蒋　博 &nbsp;蒋川群 &nbsp;李东方 &nbsp;李君丽 &nbsp;李湘梅 &nbsp;李智敏<br>
                        　　　　　　刘　江&nbsp; 刘　琴 &nbsp;佘　俊 &nbsp;宋　晖 &nbsp;苏前敏 &nbsp;吴爱华 &nbsp;向珏良 &nbsp;徐安东 &nbsp;叶文珺<br>
                        　　　　　　袁科萍 &nbsp;臧劲松 &nbsp;张向东 &nbsp;朱　敏</p>
                    <p>企业委员：施建刚&nbsp; 常庆红</p>
                    <p>秘书处：王　能&nbsp; 叶文珺&nbsp; 肖　杨</p>
                    ...
                    <p align="left">作品要求：<br>
                        　　(1)  学生在报名参赛时，根据项目的主要技术选择参赛类别。类别选择时请仔细阅读大赛各类别的评分标准（详见大赛网站）。 <br>
                        　　(2) 鼓励在竞赛作品中使用国产软件。 <br>
                        　　(3) 参赛作品是学生在课程学习或自主学习的成果总结，应该由参赛队员独立完成。若引用开源代码和第三方工具，必须在<strong>设计说明书</strong>中详细说明开源工具来源、工具所完成的功能和参赛队伍开发实现的功能。制作版权问题责任自负。 <br>
                        　　备注：企业合作项目提供软件培训，具体安排见网站通知，软件服务外包要求参照全国计算机设计大赛。 </p>
                    <h3>2．参赛对象</h3>
                    ...
                    <p align="left" class="STYLE4">② Web类别作品、其他类别中的Web形式作品必须自建好网站，在大赛参赛表中准确填写超链接，并保证评审期间能够流畅访问。 </p>
                    <p align="left" class="STYLE4">③ <span class="STYLE4">所使用的特殊开发工具和中间件必须随作品刻在光盘中一起提交。		  </span></p>
                    <p align="center"><img src="img/2016.jpg" alt="" width="571" height="601"></p>
                    <h3>4．报名与作品提交</h3>
                    <p><strong>（1）学校联络人确认：</strong>参赛学校在指定日期前上报学校联络人信息。</p>
                    <p align="left"><strong>（</strong><strong>2</strong><strong>）参赛报名：</strong>参赛队伍在规定报名时间内，由学校联系人统一登录到竞赛网站报名。每校每类型（5个类型）参赛队不超过15个。</p>
                    <p align="left"><strong>（</strong><strong>3</strong><strong>）交费：</strong>由学校在规定时间内统一交纳参赛报名费，每个参赛队200元，请汇至以下账户（汇款时，请<strong>注明参赛学校、组数、上海市计算机大赛报名费</strong>，不接受个人缴费）： <br>
                        　　　　　户名：上海电力学院 <br>
                        　　　　　账号：03370400801042136<br>
                        　　　　　开户行：农行上海昆明路支行</p>
                    <p align="left"><strong>（</strong><strong>4</strong><strong>）作品递交：</strong>所有参赛作品均请刻录成光盘（CD/DVD）后于2017年3月28日前寄送到大赛办公室（地址：上海市平凉路2103号上海电力学院教务处老行政楼305室，邮编：200090；联系人：王能 康保超；联系电话：35303885）。作品递交时须附报名缴费单据复印件。<br>
                        　　　　　竞赛网站： <strong>http://202.120.165.61/contest</strong> <br>
                        　　　　　电子邮箱： <strong>jsjdasai@shiep.edu.cn</strong><strong>、</strong><strong>shjsj@tongji.edu.cn</strong><strong> </strong></p>
                    <h3>5．评奖与奖励</h3>
                    ...
                    <h3>6．竞赛时间安排</h3>
                    <p><strong>学校联络人确认截止：</strong><strong>2016年11月15日</strong></p>
                    <p><strong>网上报名：</strong><strong>2016年12月01日到2017年1月15日</strong></p>
                    <p><strong>作品提交：2017年03月20日到03月28日</strong></p>
                    <p><strong>报名费汇款期限：2017年03月20日到03月28日</strong></p>
                    <p><strong>初　　赛：2017年04月08日到04月09日</strong></p>
                    <p><strong>决　　赛：2017年04月15日到04月16日</strong></p>
                    <p><strong>颁　　奖：2017年5月</strong></p>
                </div>
                <div class="foot">
                    <p>上海市大学生计算机应用能力大赛组委会<br>
                        2016年10月</p>
                ...
                <hr size="2"><br>
                <p align="center" class="STYLE1"><strong>2017年(第九届)上海市大学生计算机应用能力大赛学校联络人回执</strong></p>
                <p align="left" class="STYLE3">　　如果贵校将组织学生参加本次竞赛，请填写以下回执，并于2016年11月15日之前邮件发送到<a href="mailto:jsjdasai@ecnu.edu.cn">jsjdasai@shiep.edu.cn</a>和shjsj@tongji.edu.cn，以便为诸位开通网上报名账号。</p>
                ...
                <div>
                    ...
                    <p align="left" class="STYLE5">下载：<a href="2017/xx-2017001-作品情况表.doc" target="_blank" class="YYYY"><font color="0000FF">作品情况表</font></a>、<a href="2017/××-2017001-原创承诺书.doc" target="_blank"><font color="0000FF">原创承诺书</font></a>、<a href="2017/××-2017001-设计说明书——多媒体类.doc" target="_blank"><font color="0000FF">多媒体类作品设计说明书</font></a>、<a href="2017/××-2017001-设计说明书——非多媒体类.doc" target="_blank"><font color="0000FF">非多媒体类作品设计说明书</font></a>、<a href="2017/xx-2017001-作品小结.doc" target="_blank"><font color="0000FF">作品小结</font></a></p>
                </div>
                <div class="content">
                    ...
                    <h3>　　2 递交时间：</h3>
                    <p><strong>2017年03月20日</strong><strong>到03月28日</strong></p>
                    <h2>三．大赛网站及办公室</h2>
                    <p>2017年度大赛设专用网站和办公室：</p>
                    <p>大赛网站： <font color="#a50021" size="2px"><strong>http://202.120.165.61/contest</strong></font> </p>
                    <p>大赛邮箱：<strong>jsjdasai@shiep.edu.cn</strong>、<strong>shjsj@tongji.edu.cn</strong></p>
                    <p>大赛办公室设在上海电力学院杨浦校区，地址：</p>
                    <address>上海市平凉路2103号上海电力学院教务处老行政楼305室<br/>邮编：200090<br/>联系电话：35303885</address>
                    <br><p>希望各高校积极宣传、认真组织学生参赛，通过竞赛培养学生的创新能力和团队协作精神，提高学生解决实际问题的能力。</p>
                </div>
                <div class="foot">
                    <p>上海市大学生计算机应用能力大赛组委会<br>
                        上海市教育委员会高教处</p>
    ...
    <div class="row copyright">
        <div class="col-md-12 text-center">
            <p>
                ...
                <small class="block">作者：郭浩明</small>
            </p>
        </div>
    </div>
</footer>
