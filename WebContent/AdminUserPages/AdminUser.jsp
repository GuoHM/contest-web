			...
			<div class="row clearfix">
				<div class="col-xs-2 column">
					...
					<ul class="nav bs-docs-sidenav">
						<li>
							<a href="<%=basePath%>/AdminUserPages/WorksInfo.jsp">删查改报名信息</a>
						</li>
						<li>
						...
						<li>
							<a href="<%=basePath%>/AdminUserPages/EditNews.jsp">新闻编辑</a>
						</li>
						<li>
							<a href="<%=basePath%>/AdminUserPages/ModifyPassword.jsp">修改密码</a>
						</li>
					</ul>
					</nav>
				</div>
